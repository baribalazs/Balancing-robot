#Code for PiHut Controller created by approxeng. Please refer to https://approxeng.github.io for full code
...
[docs]class PiHut(Controller):
    """
    Driver for the PiHut PS3-alike controller
    """

[docs]    def __init__(self, dead_zone=0.05, hot_zone=0.05):
        """
